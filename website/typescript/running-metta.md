...
When you want an object you can feed over time, use the `MeTTa` class from `@metta-ts/hyperon`. It is modeled on Python's `hyperon`, and its space is live: atoms you add are visible to later queries.
