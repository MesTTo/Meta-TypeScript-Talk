...
// Encode a query pattern into DAS pattern_matching_query tokens.
// The grammar is das-mono's PatternMatchingQueryProcessor::setup_query_tree
...
/** True when the pattern contains a variable anywhere (so its enclosing link is a LINK_TEMPLATE). */
