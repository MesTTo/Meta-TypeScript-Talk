 ...
 * frame of variable-to-atom associations; a {@link BindingsSet} is a set of such frames (the result
 * of a match). These wrap the core's immutable binding relations behind a small mutable API that
 * reads like the Python one.
 */
